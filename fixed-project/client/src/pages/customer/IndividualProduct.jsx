...
const IndividualProduct = () => {
  ...
  const fetchProduct = async () => {
    try {
      ...
      setProductName(d.title);
      setProductDescription(d.description);
      setProductMainImg(d.mainImg);
      setProductCarouselImg1(d.carousel?.[0] || '');
      setProductCarouselImg2(d.carousel?.[1] || '');
      setProductCarouselImg3(d.carousel?.[2] || '');
      setProductSizes(d.sizes || []);
      setProductPrice(d.price);
      setProductDiscount(d.discount);
    } catch (err) {
  ...
  const buyNow = async () => {
    try {
      await axios.post('http://localhost:6001/api/orders/buy-product', {
      ...
      alert("Order failed!! Please make sure you are logged in.");
    }
  };
        ...
        <div id="carouselExampleIndicators" className="carousel slide" data-bs-ride="carousel">
          ...
          <div className="carousel-inner">
            <div className="carousel-item active">
              <img src={productCarouselImg1} className="d-block w-100" alt="product" />
            </div>
            <div className="carousel-item">
              <img src={productCarouselImg2} className="d-block w-100" alt="product" />
            </div>
            <div className="carousel-item">
              <img src={productCarouselImg3} className="d-block w-100" alt="product" />
            </div>
          </div>
            ...
            <div className="modal-body">
              <div className="checkout-address">
                ...
                <div className="form-floating mb-3">
                  <input type="text" className="form-control" id="fi1" value={name} onChange={(e) => setName(e.target.value)} />
                  <label htmlFor="fi1">Name</label>
                </div>
                <section>
                  <div className="form-floating mb-3">
                    <input type="text" className="form-control" id="fi3" value={mobile} onChange={(e) => setMobile(e.target.value)} />
                    <label htmlFor="fi3">Mobile</label>
                  </div>
                  <div className="form-floating mb-3">
                    <input type="text" className="form-control" id="fi2" value={email} onChange={(e) => setEmail(e.target.value)} />
                    <label htmlFor="fi2">Email</label>
                  </div>
                </section>
                <section>
                  <div className="form-floating mb-3">
                    <input type="text" className="form-control" id="fi6" value={address} onChange={(e) => setAddress(e.target.value)} />
                    <label htmlFor="fi6">Address</label>
                  </div>
                  <div className="form-floating mb-3">
                    <input type="text" className="form-control" id="fi7" value={pincode} onChange={(e) => setPincode(e.target.value)} />
                    <label htmlFor="fi7">Pincode</label>
                  </div>
                </section>
              </div>
              <div className="checkout-payment-method">
                ...
                <div className="form-floating mb-3">
                  <select className="form-select mb-3" id="fi8" value={paymentMethod} onChange={(e) => setPaymentMethod(e.target.value)}>
                    <option value=""></option>
                  ...
                  <label htmlFor="fi8">Choose Payment method</label>
                </div>
              </div>
            </div>
